...
const Hero = () => {
  ...
  const socialIconClass = 'flex h-12 w-12 items-center justify-center rounded-lg border border-white/10 bg-white/5 text-white transition-all duration-300 hover:-translate-y-1 hover:bg-white/10'
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-6 items-start lg:items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in lg:pt-8">
            ...
            {/* Réseaux sociaux */}
            <div
              className="glass-effect w-fit max-w-full p-3 sm:p-4 rounded-xl mb-6 lg:mb-8 animate-slide-up mx-auto lg:mx-0"
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3">
                <a
                  ...
                  className={`${socialIconClass} bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700`}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`${socialIconClass} bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800`}
                  aria-label="Facebook"
                  title="Facebook"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`${socialIconClass} bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700`}
                  aria-label="WhatsApp"
                  title="WhatsApp"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-12 w-12 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-900 transition-all duration-300 hover:-translate-y-1 hover:bg-gray-50"
