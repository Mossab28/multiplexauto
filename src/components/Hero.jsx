      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center animate-fade-in">
          <div className="inline-block mb-6">
            <span className="bg-racing-red/20 text-racing-red px-4 py-2 rounded-full text-sm font-semibold border border-racing-red/30">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 animate-slide-up" style={{ animationDelay: '0.4s' }}>
            <a
              href="#contact"
              className="bg-racing-red hover:bg-red-700 text-white px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300 hover-lift w-full sm:w-auto"
            >
              Demander un Devis
            </a>
            <a
              href="#services"
              className="glass-effect hover:bg-white/10 text-white px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300 hover-lift w-full sm:w-auto"
            >
              Nos Services
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto animate-slide-up" style={{ animationDelay: '0.6s' }}>
            <div className="glass-effect p-6 rounded-xl hover-lift">
              <Shield className="w-12 h-12 text-racing-red mx-auto mb-3" />
              <h3 className="font-racing font-bold text-lg mb-2">Protection UV</h3>
              <p className="text-gray-400 text-sm">99% des rayons UV bloqués</p>
            </div>
            <div className="glass-effect p-6 rounded-xl hover-lift">
              <Sparkles className="w-12 h-12 text-racing-red mx-auto mb-3" />
              <h3 className="font-racing font-bold text-lg mb-2">Finition Premium</h3>
              <p className="text-gray-400 text-sm">Installation professionnelle</p>
            </div>
            <div className="glass-effect p-6 rounded-xl hover-lift">
              <Award className="w-12 h-12 text-racing-red mx-auto mb-3" />
              <h3 className="font-racing font-bold text-lg mb-2">Garantie Qualité</h3>
