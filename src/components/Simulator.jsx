...
const Simulator = () => {
  ...
  return (
    <div className="min-h-screen bg-matte-black pt-24 pb-12">
          ...
          <div className="glass-effect p-8 rounded-2xl min-h-[400px] animate-fade-in">
            ...
            {step === 5 && (
              <div className="animate-slide-up text-center">
                <div className="mb-8">
                  <div className="w-20 h-20 bg-silver-accent/20 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Check className="w-10 h-10 text-silver-accent" />
                  </div>
                ...
                <div className="bg-white/5 rounded-xl p-8 mb-8">
                  ...
                  <div className="pt-6 border-t-2 border-silver-accent">
                    <div className="flex justify-between items-center">
                      <span className="text-2xl font-racing font-bold text-white">TOTAL ESTIMÉ</span>
                      <span className="text-4xl font-racing font-bold gradient-text">
                        {calculatePrice()}€
                      </span>
                    </div>
